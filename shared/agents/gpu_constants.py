...
# Thermal recovery state - brain-initiated reset for thermal incident
RUNTIME_STATE_RESETTING_THERMAL = "resetting_thermal"
...
RUNTIME_STATES_RECOVERING = {RUNTIME_STATE_RECOVERING_SPLIT, RUNTIME_STATE_RECOVERING_SINGLE, RUNTIME_STATE_RESETTING_THERMAL}
